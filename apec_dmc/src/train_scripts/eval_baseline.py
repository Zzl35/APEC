...
class WorkspaceIL:
    def __init__(self, cfg, work_dir):
        ...
        self.pbrl_reward_model.load_state_dict(torch.load(cfg.baseline_reward_path))
        print(f'Load reward model from {cfg.baseline_reward_path}')
...
def main(cfg):
    workspace = WorkspaceIL(cfg, work_dir=f'eval_baseline/{cfg.suite.name}_{cfg.num_demos}/{cfg.task_name}/{cfg.baseline_type}/{cfg.seed}')
