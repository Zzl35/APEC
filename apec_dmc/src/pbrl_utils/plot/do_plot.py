...
from pbrl_utils.plot.plot_diversity import tsne_visualization, compute_diversity, plot_knn_consistency
from pbrl_utils.plot.plot_correlation import return_correlation, reward_correlation
from pbrl_utils.plot.plot_reusability import visual_reusability
from pbrl_utils.plot.plot_accuracy import compute_consistency, visual_consistency, visual_accuracy
...
if __name__ == '__main__':
    ...
    require_buffer = True if parameter.plot_diversity or parameter.plot_corr or parameter.plot_consistency else False
    ...
    if parameter.plot_corr:
        ...
        # 训练集指标
        # train_return_df = pd.DataFrame.from_dict(total_train_return_corrs, orient='index')
        # train_return_stats_df = calculate_stats(total_train_return_corrs)
        # train_return_stats_df.to_csv(f'eval/{plot_dir}/return_correlation/total_train_return_correlation.csv')
        # train_return_df.to_csv(f'eval/{plot_dir}/return_correlation/total_train_return_correlation_data.csv')      
