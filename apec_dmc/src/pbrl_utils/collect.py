import numpy as np
import torch
from pbrl_utils.it_estimator import entropy as it_entropy
from pbrl_utils.it_estimator import kldiv
...
def collect_trajectories_policy_single(env, sac_agent, n=2000, state_indices=None, render=False, return_reward=False):
    ...
    for traj_no in range(n):
        ...
        for i in range(T):
            ...
            s_nxt, reward, _, _ = env.step(a) # assign reward online
            s_buffer[traj_no,i,:] = s
            a_buffer[traj_no,i,:] = a
            r_buffer[traj_no,i,0] = reward
